...
param virtualNetworkName string = 'vnet-diravd-prod-01'
...
param virtualMachineSizeDC string = 'Standard_D2ns_v6'
...
param avdSessionHostSize string = 'Standard_D2ns_v6'
...
param rampDownStartTimeHour int = 19 // Hour to start ramp-down schedule
...
param offPeakStartTimeHour int = 20 // Hour to start off-peak schedule
